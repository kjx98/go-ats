...
func TestPeriodBaseTime(t *testing.T) {
	...
	if td := timeT64(t1).Time(); td.Second() != 0 {
	...
	if td := timeT64(t1).Time(); td.Second() != 0 || td.Minute()%5 != 0 {
	...
	if td := timeT64(t1).Time(); td.Second() != 0 || td.Minute() != 0 || td.Hour() != 0 {
	...
	if td := timeT64(t1).Time(); td.Second() != 0 || td.Minute() != 0 || td.Hour() != 0 || td.Weekday() != 0 {
